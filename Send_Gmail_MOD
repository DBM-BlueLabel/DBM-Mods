...
fields: ["username", "password", "mailto", "subject", "text", "iffalse", "iffalseVal"],
...
<div style="width: 550px; height: 350px; overflow-y: scroll;">
	...
	<div style="float: left; width: 50%;">
		Password:<br>
		<input id="password" class="round" type="password">
	</div><br><br><br>
	<div style="float: left; width: 50%;">
		mailto:<br>
    ...
    Text:<br>
    <textarea id="text" rows="9" style="width: 90%;"></textarea>
    </div>
...
action: function(cache) {
    ...
    const subject = this.evalMessage(data.subject, cache);
